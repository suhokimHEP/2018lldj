...
void makePUweights(TString Tsample)
{
 ...
 tinpath.Append("/src/2018lldj/commontools/amcpileup/");

 // set up names
 TString inname_mc = "2018_mc_PU.txt";
 ...
 TString oname_base = "2018_puWeights_"+Tsample+"_69200" ;
 ...
 title->DrawTextNDC(0.13,0.91,"CMS");
 extra->DrawTextNDC(0.23,0.91,"Preliminary");
 lumi->DrawTextNDC(0.9,0.91,"59.1 /fb (13 TeV)");
