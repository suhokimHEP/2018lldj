...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file://DD967656-BACC-DD40-BA44-7E309FF8D393.root')
)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('lldjntuple_mc_AOD.root')
)
...
process.patCandidatesTask = cms.Task(process.makePatElectronsTask, process.makePatJetsTask, process.makePatLowPtElectronsTask, process.makePatMETsTask, process.makePatMuonsTask, process.makePatPhotonsTask, process.makePatTausTask)
