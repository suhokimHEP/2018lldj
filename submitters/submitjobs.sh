...
makeasubmitdir () {
 ...
 printf "Transfer_Input_Files = ${CMSSW_BASE}/src/${FWVersion}/analyzers/runanalyzer.exe,${CMSSW_BASE}/src/${FWVersion}/lists/$1.list,${CMSSW_BASE}/src/${FWVersion}/lists/$1.info,${CMSSW_BASE}/src/${FWVersion}/analyzers/2018_puWeights_EGamma_69200.root,${CMSSW_BASE}/src/${FWVersion}/analyzers/2018_puWeights_MuonEG_69200.root,${CMSSW_BASE}/src/${FWVersion}/analyzers/puWeights_SinglePhoton_69200.root,${CMSSW_BASE}/src/${FWVersion}/analyzers/2018_puWeights_DoubleMuon_69200.root,${CMSSW_BASE}/src/${FWVersion}/analyzers/2018_ElectronTight.root,${CMSSW_BASE}/src/${FWVersion}/analyzers/2018_ElectronMedium.root,${CMSSW_BASE}/src/${FWVersion}/analyzers/2018_ElectronLoose.root,${CMSSW_BASE}/src/${FWVersion}/analyzers/feff_ZH.root,${CMSSW_BASE}/src/${FWVersion}/analyzers/Zsf.root,${CMSSW_BASE}/src/${FWVersion}/analyzers/Zsf_0Jet.root,${CMSSW_BASE}/src/${FWVersion}/analyzers/Zsf_1Jet.root,${CMSSW_BASE}/src/${FWVersion}/analyzers/Zsf_nJet.root,${CMSSW_BASE}/src/${FWVersion}/analyzers/puWeights_69200_24jan2017.root\n" >> submitfile
