...
public :
 ...
 void            loadElectronTrig();
 void            loadElectronWeight( TString eleid );
 void            loadMuonWeight( TString muoid );
 void            loadMuonIso( TString muoid );
 Float_t         makeElectronReco( std::vector<int> &electron_list, float &eleReco_Unc, std::vector<float> &eleReco_ind );
 Float_t         makeElectronTrig( std::vector<int> &electron_list, float &eleTrig_Unc, std::vector<float> &eleTrig_ind );
...
// Float_t         makeTTWeight( Float_t TTavgweight );
 ...
 float eleReco_Unc,eleTrig_Unc,eleID_Unc,muonID_Unc,muonISO_Unc,LeptonSF_Unc,ESF_Unc, MSF_Unc = 0.;
 std::vector<float> eleReco_ind, eleTrig_ind, eleID_ind, muonID_ind, muonISO_ind;
