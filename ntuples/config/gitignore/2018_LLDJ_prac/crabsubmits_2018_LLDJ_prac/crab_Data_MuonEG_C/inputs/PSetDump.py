...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/data/Run2018C/MuonEG/AOD/17Sep2018-v1/810000/E462389C-0A89-414A-BCF3-0BC9CA026DBC.root')
)
...
process.patElectrons = cms.EDProducer("PATElectronProducer",
    ...
    userData = cms.PSet(
        ...
        userClasses = cms.PSet(
            src = cms.VInputTag(cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Fall17-94X-V1-loose"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Fall17-94X-V1-medium"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Fall17-94X-V1-tight"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Fall17-94X-V1-veto"))
        ),
        userFloats = cms.PSet(
            src = cms.VInputTag("")
        ),
...
process.patPhotons = cms.EDProducer("PATPhotonProducer",
    ...
    userData = cms.PSet(
        ...
        userClasses = cms.PSet(
            src = cms.VInputTag(
                cms.InputTag("egmPhotonIDs","cutBasedPhotonID-Fall17-94X-V1-loose"), cms.InputTag("egmPhotonIDs","cutBasedPhotonID-Fall17-94X-V1-medium"), cms.InputTag("egmPhotonIDs","cutBasedPhotonID-Fall17-94X-V1-tight"), cms.InputTag("egmPhotonIDs","mvaPhoID-RunIIFall17-v1-wp80"), cms.InputTag("egmPhotonIDs","mvaPhoID-RunIIFall17-v1-wp90"), 
                cms.InputTag("egmPhotonIDs","mvaPhoID-RunIIFall17-v1p1-wp80"), cms.InputTag("egmPhotonIDs","mvaPhoID-RunIIFall17-v1p1-wp90"), cms.InputTag("egmPhotonIDs","cutBasedPhotonID-Spring16-V2p2-loose"), cms.InputTag("egmPhotonIDs","cutBasedPhotonID-Spring16-V2p2-medium"), cms.InputTag("egmPhotonIDs","cutBasedPhotonID-Spring16-V2p2-tight"), 
                cms.InputTag("egmPhotonIDs","mvaPhoID-Spring16-nonTrig-V1-wp80"), cms.InputTag("egmPhotonIDs","mvaPhoID-Spring16-nonTrig-V1-wp90"), cms.InputTag("egmPhotonIDs","mvaPhoID-RunIIFall17-v2-wp80"), cms.InputTag("egmPhotonIDs","mvaPhoID-RunIIFall17-v2-wp90"), cms.InputTag("egmPhotonIDs","cutBasedPhotonID-Fall17-94X-V2-loose"), 
                cms.InputTag("egmPhotonIDs","cutBasedPhotonID-Fall17-94X-V2-medium"), cms.InputTag("egmPhotonIDs","cutBasedPhotonID-Fall17-94X-V2-tight")
            )
        ),
        userFloats = cms.PSet(
            src = cms.VInputTag("")
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('lldjntuple_data_AOD.root')
)
...
process.egammaScaleSmearTask = cms.Task(process.calibratedElectrons, process.calibratedPhotons)


process.selectedPatCandidatesTask = cms.Task(process.selectedPatElectrons, process.selectedPatJets, process.selectedPatLowPtElectrons, process.selectedPatMuons, process.selectedPatPhotons, process.selectedPatTaus)
...
process.patCandidatesTask = cms.Task(process.makePatElectronsTask, process.makePatJetsTask, process.makePatLowPtElectronsTask, process.makePatMETsTask, process.makePatMuonsTask, process.makePatTausTask, process.patPhotons, process.pfParticleSelectionForIsoTask, process.pfPhotonIsolationPATTask)
...
process.egammaPostRecoSeq = cms.Sequence(process.egmGsfElectronIDSequence+process.egmPhotonIDSequence+process.egammaScaleSmearSeq)


process.p = cms.Path(process.egammaPostRecoSeq+process.ak4CaloCorrectedJets+process.ak4CaloL1FastL2L3ResidualCorrectorChain+process.particleFlowPtrs+process.patCandidates+process.selectedPatCandidates+process.lldjNtuple)
